  ...
  return (
    <Html lang="en">
      <Head>
        ...
        {/* Favicon: 48px PNG first so Google can crop a clean circular icon */}
        <link rel="icon" type="image/png" sizes="48x48" href="/favicons/acehost-48.png?v=4" />
        <link rel="icon" type="image/png" sizes="192x192" href="/favicons/acehost-192.png?v=4" />
        <link rel="icon" type="image/png" sizes="96x96" href="/favicons/acehost-96.png?v=4" />
        <link rel="icon" href="/favicons/favicon.ico?v=4" sizes="any" />
