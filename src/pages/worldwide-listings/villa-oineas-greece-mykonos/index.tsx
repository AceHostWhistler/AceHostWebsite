      ...
      <div className="min-h-screen bg-white">
        ...
        <main>
          ...
          <div className="bg-gray-50 rounded-lg p-8 mb-20">
            ...
            <div className="mb-8">
              <h3 className="text-xl font-semibold mb-4">Event Rates</h3>
              <div className="overflow-x-auto">
                <table className="min-w-full border border-gray-300">
                  <thead>
                    <tr className="bg-gray-100">
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider border-b">Event Size</th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider border-b">Rate (€)</th>
                    </tr>
                  </thead>
                  <tbody className="bg-white divide-y divide-gray-300">
