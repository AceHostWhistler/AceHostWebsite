        ...
        <main className="pt-24 pb-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <p>
                Chalet La Forja is for families who want to go big. It sleeps up to 15 guests with
                7.5 bedrooms, 15 beds, and 8 bathrooms, which makes it a great fit for larger family
