...
const Home = () => {
          ...
          <Link href={cardLink}>
            {isCotswolds ? (
              <div className="w-full h-full">
                <img
                  src="/photos/properties/Cotswolds UK - Soho Farm House/Final Pool Drone money shot good.png"
                  ...
                  onError={(e) => {
                    ...
                    target.onerror = null;
                    target.src = "/photos/properties/Cotswolds UK - Soho Farm House/Final Pool Drone money shot good.png";
                  }}
                />
              </div>
            ) : (
  ...
  const allListings = [
    ...
    },
    {
      ...
      image: "/photos/properties/Timber Haven John Harris/95 - 20260506 MM4P 02 0367.jpg",
      guests: 16,
      bedrooms: 8,
      beds: 10,
      bathrooms: 6.5,
    ...
    },
    {
      ...
      image: "/photos/properties/Falcon/Outdoor shot Falcon good.png",
      guests: 15,
      bedrooms: 7,
      beds: 9,
      bathrooms: 3.5,
    ...
    },
    {
      ...
      image: "/photos/properties/Cotswolds UK - Soho Farm House/Final Pool Drone money shot good.png",
      guests: 15,
      bedrooms: 8,
      bathrooms: 5,
