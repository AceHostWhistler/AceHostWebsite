  ...
  const ConciergeCard = ({ 
    ...
    return (
      <div className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-all duration-300">
        ...
        <div className="p-4">
          <h3 className="text-[17px] font-medium tracking-tight text-gray-900 mb-1.5 leading-snug">
            <span className="service-icon mr-1.5 inline-flex items-center justify-center">
              {icon}
            </span>
            {title}
          </h3>
          <div className="card-text-container text-[13px] leading-relaxed text-gray-600" style={{ 
            maxHeight: isExpanded ? '1000px' : '68px',
            position: 'relative'
          }}>
            <p className="mb-1.5">
              {description}
    ...
    <>
      ...
      <div className="min-h-screen bg-white font-sans antialiased">
        ...
        <main className="pb-12">
            ...
            <div className="relative z-10 w-full px-4 pb-8 pt-24 sm:px-6 sm:pb-10 lg:px-8">
              <div className="mx-auto grid max-w-7xl items-center gap-6 lg:grid-cols-12">
                <div className="concierge-hero-copy lg:col-span-7">
                  <h1 className="mb-3 text-2xl font-semibold tracking-tight leading-[1.12] sm:text-3xl lg:text-[2.35rem]">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {[
                      ...
                      <span
                        key={label}
                        className="inline-flex items-center rounded-full border border-white/30 bg-white/10 px-2.5 py-0.5 text-[11px] font-medium text-white"
                      >
                        {label}
                      </span>
                    ))}
                  ...
                  <div className="mt-5 flex flex-col sm:flex-row gap-3">
                    <a
                      href="#services"
                      className="inline-flex items-center justify-center rounded-lg bg-white px-5 py-2.5 text-sm font-semibold text-stone-950 transition-colors hover:bg-stone-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-stone-950"
                    >
                      Explore Services
                    </a>
                    <Link
                      href="/contact"
                      className="inline-flex items-center justify-center rounded-lg border border-white/40 bg-white/5 px-5 py-2.5 text-sm font-semibold text-white transition-colors hover:border-white/60 hover:bg-white/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-stone-950"
                    >
                      Contact Us
                    </Link>
                  </div>
          ...
          <section className="bg-[#f6f3ed] border-b border-stone-300/50 py-8 sm:py-9">
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
              <h2 className="text-xl md:text-2xl font-medium tracking-tight text-stone-900 mb-4">
                Explore Our Concierge Services
              </h2>
              <div className="space-y-4 text-sm sm:text-[15px] text-stone-800 leading-relaxed">
                <p>
          ...
          <section id="services" className="py-10 sm:py-12 bg-gray-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <h2 className="text-xl sm:text-2xl font-medium tracking-tight text-gray-900 mb-3">
                Our Concierge Services
              </h2>
              <p className="text-sm sm:text-[15px] text-gray-600 mb-6 max-w-3xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <ConciergeCard
                  index={1}
                  icon={<FaSkiing className="text-sm" />}
                ...
                <ConciergeCard
                  index={2}
                  icon={<GiCookingPot className="text-sm" />}
                ...
                <ConciergeCard
                  index={5}
                  icon={<FaSnowflake className="text-sm" />}
                ...
                <ConciergeCard
                  index={7}
                  icon={<FaSnowplow className="text-sm" />}
                ...
                <ConciergeCard
                  index={8}
                  icon={<GiMountainCave className="text-sm" />}
                ...
                <ConciergeCard
                  index={9}
                  icon={<MdAirportShuttle className="text-sm" />}
                ...
                <ConciergeCard
                  index={10}
                  icon={<GiDogHouse className="text-sm" />}
                  title="Dog Sledding"
                ...
                <ConciergeCard
                  index={11}
                  icon={<BiDrink className="text-sm" />}
                ...
                <ConciergeCard
                  index={14}
                  icon={<FaMountain className="text-sm" />}
                  title="Zipline Tours"
                ...
                <ConciergeCard
                  index={11}
                  icon={<FaHiking className="text-sm" />}
                ...
                <ConciergeCard
                  index={12}
                  icon={<GiMountainRoad className="text-sm" />}
                ...
                <ConciergeCard
                  index={14}
                  icon={<GiFoodTruck className="text-sm" />}
                  title="Catered Meals"
                ...
                <ConciergeCard
                  index={20}
                  icon={<FaWineGlassAlt className="text-sm" />}
                ...
                <ConciergeCard
                  index={22}
                  icon={<FaConciergeBell className="text-sm" />}
                ...
                <ConciergeCard
                  index={23}
                  icon={<MdCleaningServices className="text-sm" />}
                ...
                <ConciergeCard
                  index={25}
                  icon={<MdChildCare className="text-sm" />}
                ...
                <ConciergeCard
                  index={27}
                  icon={<GiBabyBottle className="text-sm" />}
                ...
                <ConciergeCard
                  index={30}
                  icon={<FaPlane className="text-sm" />}
                ...
                <ConciergeCard
                  index={37}
                  icon={<BiInjection className="text-sm" />}
          ...
          <section className="py-10 sm:py-12 bg-gray-50">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              <h2 className="text-xl sm:text-2xl font-medium tracking-tight text-gray-900 mb-3 text-center">
                Frequently Asked Questions
              </h2>
              <p className="text-sm sm:text-[15px] text-gray-600 mb-7 text-center max-w-2xl mx-auto">
              ...
              <div className="space-y-2.5">
                ...
                >
                  <button
                    onClick={() => toggleFaq(0)}
                    className="w-full flex justify-between items-center px-4 py-3.5 text-left focus:outline-none"
                  >
                    <h3 className="text-sm sm:text-[15px] font-medium tracking-tight text-gray-900">
          ...
          {/* Contact Section */}
          <section className="py-12 bg-white text-black border-t border-gray-100">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              <h2 className="text-xl sm:text-2xl font-medium tracking-tight mb-3">
                Interested in Concierge Services?
              </h2>
              <p className="text-sm sm:text-[15px] mb-6 max-w-2xl mx-auto text-gray-700">
                Let us enhance your Whistler experience with our premium
                concierge services.
              </p>
              <Link
                href="/contact"
                className="inline-block bg-white text-black font-medium px-6 py-2.5 rounded-full border border-gray-200 hover:border-gray-400 shadow-sm hover:shadow transition duration-200 text-sm"
              >
                Contact Us
              </Link>
            </div>
