...
export const propertyCategories: PropertyCategory[] = [
      {
        ...
        properties: [
...

          {
            ...
            location: "Upper Village, Whistler",
            description:
              "Le Chamois at the base of Blackcomb Mountain with a 2-minute walk to the gondola and ski-out. King suite, Murphy bedroom, free parking, pool, hot tub and gym.",
            features: [
          ...
          {
            id: "cascade-lodge-615",
            name: "Cascade Lodge #615 | Premium View",
            images: [
