...
const listing: ListingData = {
  ...
  seo: {
    title: "Whistler Village Views | Luxury 2.5 Bedroom - AceHost",
    description: "Experience luxury living in this stunning 2.5 bedroom property in the heart of Whistler Village. Features breathtaking views of Olympic Plaza and Blackcomb Mountain, modern amenities, and sleeps up to 6 guests. Perfect for families and groups seeking a premium Whistler experience. Nightly rates from $400-$1,150+.",
  },
  header:   {
