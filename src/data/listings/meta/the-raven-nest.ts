...
const listing: ListingData = {
  ...
  seo: {
    title: "Raven's Nest | Ski-in/Ski-out with Views | AceHost",
    description: "Experience luxury at Raven's Nest in Whistler. Ski-in/ski-out convenience with stunning mountain views. Perfect for your Whistler getaway. Book now!",
  },
  header:   {
