export type Whistler28Property = {
  number: number;
  name: string;
  description: string;
  footnote?: string;
...
export const largeHomeProperties: Whistler28Property[] = [
  {
    number: 7,
  ...
  },
  {
    ...
    description:
      "A standalone chalet on Nicklaus North Golf Course with a private hot tub, media room, chef's kitchen, and beautiful year-round views.",
    image: "/photos/properties/Muirfield Golf Course/Muirfield drone snow.png",
    listingHref: "/listings/golf-course-views-luxury-4-bed-whistler-village",
    bookUrl:
  ...
  },
  {
    ...
    description:
      "A hard-to-find three-bedroom Village home with a private hot tub and easy walking access to restaurants, shops, and the slopes.",
    image: "/photos/properties/John 3-bed Granite Court/03 - 20251125 A7M4 01 A1_01852.jpg",
    listingHref: "/listings/rare-3-bedroom-whistler-village-walk-to-hill",
    bookUrl:
  ...
  },
  {
    ...
    description:
      "A ten-bedroom private lodge for up to 26 guests, with a spa, pool, sauna, gym, theatre, event spaces, and room for major celebrations.",
    ...
    listingHref: "/listings/wedge-mountain-lodge-spa",
    contactOnly: true,
  },
];

export const townhomeProperties: Whistler28Property[] = [
  {
    number: 15,
    name: "Luxe Cozy 3-Bed Whistler Village",
    description:
      "A cozy three-bedroom Blackcomb townhome with a private hot tub, wood-burning fireplace, and Lost Lake trail access.",
    image:
  ...
  },
  {
    ...
    description:
      "A five-bedroom ski-in, ski-out home for extended stays, with a private hot tub and a strong group layout.",
    image: "/photos/properties/Wolverine Crescent/01 - 20251220 A7M4 01 A1_01116-Edit.jpg",
    listingHref: "/listings/the-nest-ski-in-ski-out",
    bookUrl:
  ...
  },
  {
    ...
    description:
      "A peaceful two-bedroom lakefront condo with mountain views and easy access to golf, trails, restaurants, and ski areas.",
